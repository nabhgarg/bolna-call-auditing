...
export const CHECKS: CheckDef[] = [
  ...
  },
  {
    ...
    laneReason: "Whether it says them the way a person from that place would say them.",
  ...
  },
  {
    ...
    work: "Whether it sounds like a person · pacing, warmth, awkward pauses.",
    laneReason: "The thing a customer notices in the first five seconds and cannot name.",
    match: /tone|rude|robot|natural|empath|polite|sounds?|pace|abrupt/i,
  },
  {
    id: "barge_in", name: "Barge-in · talking over the customer", routing: "judge", priceInr: 3, samplePct: 1, unit: "per_call",
    work: "Every time the agent cuts in while the customer is still speaking.",
    laneReason: "Counted on every call, not a sample · the timing tells us outright.",
    match: /interrupt|talks? over|cuts? (them |people |the customer )?off|barge/i,
  },
  {
    id: "compliance", name: "Did it say what it must say", routing: "judge_human_verified",
    priceInr: 4, verifyInr: 8, samplePct: 1, flagPct: 0.1, unit: "per_verified",
    work: "Your mandatory lines · disclosures, consent, the recorded-call notice · said in full, not skipped or rushed.",
    laneReason: "",
